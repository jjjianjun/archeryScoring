    ...
    $.fn.numpad=function(options){
		...
		return this.each(function(){
			...
			if ($('#'+id).length == 0) {
				...
				table.append(
					$(options.rowTpl)
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(7).addClass('numero').attr('id', "button7").css({"background-color": "red", "color" : ""})))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(8).addClass('numero').attr('id', "button8").css({"background-color": "red", "color" : ""})))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(9).addClass('numero').attr('id', "button9").css({"background-color": "yellow", "color" : ""})))
					...
					$(options.rowTpl)
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(4).addClass('numero').attr('id', "button4").css({"background-color": "black", "color" : "white"})))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(5).addClass('numero').attr('id', "button5").css({"background-color": "#00abf3", "color" : ""})))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(6).addClass('numero').attr('id', "button6").css({"background-color": "#00abf3", "color" : ""})))
...
/* 						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.textClear).addClass('clear').click(function(){
					...
					$(options.rowTpl)
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(1).addClass('numero').attr('id', "button1").css({"background-color": "white", "color" : ""})))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(2).addClass('numero').attr('id', "button2").css({"background-color": "white", "color" : ""})))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(3).addClass('numero').attr('id', "button3").css({"background-color": "black", "color" : "white"})))
/* 						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.textCancel).addClass('cancel').click(function(){
							nmpd.close(false);
						}))) */
					).append(
...
/* 						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html('&plusmn;').addClass('neg').click(function(){
						...
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html("").addClass('numero').css("visibility", "hidden")))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html("M").addClass('numero').css({"background-color": "orange", "color": ""})))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html("").addClass('numero').css("visibility", "hidden")))
/* 						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.decimalSeparator).addClass('sep').click(function(){
			...
			*/
			nmpd.setValue = function(value){
				...
				{	
					// To take the last number in the input
					value = value.toString().substr((value.toString().length)-1, nmpd.display.attr('maxLength')); 	console.log(value);
				}
				// if M has been clicked, number is 0
				if(value == "M" || value == "m") { value = "0"; } console.log(value);
